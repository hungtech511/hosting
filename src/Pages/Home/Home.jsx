...
import { accordionLists, listBackgroundHomeImage } from "@utils/constant"
import HomeServices from "@layouts/HomeServices"
import "./Home.scss"
import CustomizedAccordions from "@layouts/Accordion"
import HeadingTitle from "@components/HeadingTitle"
import AccordionIner from "@layouts/Accordion/AccordionIner"
    ...
    <>
      {listBackgroundHomeImage.map((item, index) => {
        return (
          <ItemBackground
            key={item?.id}
            className={`icon-layer ${item?.className}`}
          ...
          <Box className="banner-section">
            ...
            <Container fixed={true} maxWidth="lg">
              <Grid container spacing={2}>
                <Grid className="content-column" xs={6}>
                  <Box className="inner-column">
                    <Typography color={colors.white} variant="h1">
                      Reliable & Ultrafast Websites Hosting & Stores.
                    </Typography>
                    <Typography
                      color={colors.white}
                ...
                <Grid className="image-column" xs={6}>
                  <Box className="image-wrapper">
                    ...
                    <Box
                      className="image-pattern-layer layer-2 image-animation"
                      sx={{
                        backgroundImage: `url(https://themexriver.com/wp/hostix/wp-content/uploads/2023/01/part_2.png)`,
                      }}></Box>
                    <img
                      src="https://themexriver.com/wp/hostix/wp-content/uploads/2023/01/main.png"
                      alt="image"
                    />
                  </Box>
                </Grid>
